...
class ScalarFieldTheory:
    ...
    def generate_configuration(self, beta, n_steps=1000):
...
if __name__ == "__main__":
    ...
    train_configs, train_labels = generate_dataset(n_samples=2000)
    val_configs, val_labels = generate_dataset(n_samples=400)
    ...
    beta_range = np.linspace(0.1, 1.0, 50)
